...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'lyricsshop.meeta.online', 'port' => '', 'dbname' => 'lyricsshop', 'user' => 'lyricsshop', 'password' => 'Ponycorn_90', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.0999999999999996), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_ddc4862576aa02c37afa6cdeafc2be17b304f222c48776bc85656b2e2e310c45');
    ...
    {
        return $this->services['prestashop.adapter.memcache_server.manager'] = new \PrestaShop\PrestaShop\Adapter\Cache\MemcacheServerManager($this->get('doctrine.dbal.default_connection'), 'lys');
    }
    ...
    {
        return $this->services['prestashop.core.api.category.repository'] = new \PrestaShopBundle\Entity\Repository\CategoryRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'lys');
    }
    ...
    {
        return $this->services['prestashop.core.api.feature_attribute.repository'] = new \PrestaShopBundle\Entity\Repository\FeatureAttributeRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'lys');
    }
    ...
    {
        return $this->services['prestashop.core.api.manufacturer.repository'] = new \PrestaShopBundle\Entity\Repository\ManufacturerRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'lys');
    }
    ...
    {
        return $this->services['prestashop.core.api.stockmovement.repository'] = new \PrestaShopBundle\Entity\Repository\StockMovementRepository($this, $this->get('doctrine.dbal.default_connection'), $this->get('doctrine.orm.default_entity_manager'), $this->get('prestashop.adapter.legacy.context'), $this->get('prestashop.adapter.image_manager'), 'lys');
    }
    ...
    {
        return $this->services['prestashop.core.api.supplier.repository'] = new \PrestaShopBundle\Entity\Repository\SupplierRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'lys');
    }
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('lys');
    }
    ...
    {
        return $this->services['prestashop.module_kernel.repository'] = new \PrestaShopBundle\Kernel\ModuleRepository($this->get('doctrine.dbal.default_connection'), 'lys');
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \PrestaShopBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json'), 'prestashop.translation.database_loader' => array(0 => 'db')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => false, 'resource_files' => array('mn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf')), 'az' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.az.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.az.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.az.xlf')), 'cs' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.cs.xlf')), 'uk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf')), 'sr_Latn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Latn.xlf')), 'bg' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.bg.xlf')), 'th' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.th.xlf')), 'ca' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ca.xlf')), 'sk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sk.xlf')), 'ro' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ro.xlf')), 'pt_BR' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_BR.xlf')), 'id' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.id.xlf')), 'hu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hu.xlf')), 'fi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf')), 'da' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.da.xlf')), 'gl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.gl.xlf')), 'es' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.es.xlf')), 'it' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.it.xlf')), 'sl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sl.xlf')), 'de' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.de.xlf')), 'et' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf')), 'pt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf')), 'eu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf')), 'hr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hr.xlf')), 'he' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.he.xlf')), 'zh_CN' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.zh_CN.xlf')), 'en' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.en.xlf')), 'ja' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ja.xlf')), 'el' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.el.xlf')), 'sv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sv.xlf')), 'pl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pl.xlf')), 'fa' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fa.xlf')), 'hy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf')), 'fr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fr.xlf')), 'zh_TW' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf')), 'sr_Cyrl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Cyrl.xlf')), 'sq' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf')), 'ru' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ru.xlf')), 'lt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lt.xlf')), 'tr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.tr.xlf')), 'ar' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ar.xlf')), 'lb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lb.xlf')), 'cy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf')), 'af' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf')), 'lv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lv.xlf')), 'nl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.nl.xlf')), 'nn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nn.xlf')), 'vi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.vi.xlf')), 'no' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.no.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.no.xlf')), 'pt_PT' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_PT.xlf')), 'ua' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ua.xlf')), 'en-US' => array(0 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminActions.en-US.xlf'), 1 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminDesignHelp.en-US.xlf'), 2 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCategorytreeAdmin.en-US.xlf'), 3 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCrosssellingAdmin.en-US.xlf'), 4 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminStatsFeature.en-US.xlf'), 5 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminInternationalHelp.en-US.xlf'), 6 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSupplierlistShop.en-US.xlf'), 7 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminNavigationSearch.en-US.xlf'), 8 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCustomersigninAdmin.en-US.xlf'), 9 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesFacetedsearchShop.en-US.xlf'), 10 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesProductinfoAdmin.en-US.xlf'), 11 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminPaymentFeature.en-US.xlf'), 12 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesLegalcomplianceShop.en-US.xlf'), 13 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesGAnalyticsAdmin.en-US.xlf'), 14 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsbestproductsAdmin.en-US.xlf'), 15 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopDemoCatalog.en-US.xlf'), 16 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsbestmanufacturersAdmin.en-US.xlf'), 17 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopNotificationsWarning.en-US.xlf'), 18 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsbestcustomersAdmin.en-US.xlf'), 19 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSekeywordsAdmin.en-US.xlf'), 20 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesBlockreassuranceAdmin.en-US.xlf'), 21 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsbestsuppliersAdmin.en-US.xlf'), 22 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesDateofdeliveryAdmin.en-US.xlf'), 23 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatscarrierAdmin.en-US.xlf'), 24 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesReminderAdmin.en-US.xlf'), 25 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesContactinfoShop.en-US.xlf'), 26 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesDateofdeliveryShop.en-US.xlf'), 27 => ($this->targetDirs[2].'/Resources/translations/en-US/EmailsBody.en-US.xlf'), 28 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesShoppingcartAdmin.en-US.xlf'), 29 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesEmailsubscriptionShop.en-US.xlf'), 30 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSpecialsShop.en-US.xlf'), 31 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminStatsNotification.en-US.xlf'), 32 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSpecialsAdmin.en-US.xlf'), 33 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesDashproductsAdmin.en-US.xlf'), 34 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopPdf.en-US.xlf'), 35 => ($this->targetDirs[2].'/Resources/translations/en-US/EmailsSubject.en-US.xlf'), 36 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsdataAdmin.en-US.xlf'), 37 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminOrderscustomersFeature.en-US.xlf'), 38 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminDashboardNotification.en-US.xlf'), 39 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesLinklistAdmin.en-US.xlf'), 40 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesTrackingfrontAdmin.en-US.xlf'), 41 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminShippingFeature.en-US.xlf'), 42 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesBannerAdmin.en-US.xlf'), 43 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesBestsellersAdmin.en-US.xlf'), 44 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsvisitsAdmin.en-US.xlf'), 45 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminShopparametersNotification.en-US.xlf'), 46 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesFeaturedproductsAdmin.en-US.xlf'), 47 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsproductAdmin.en-US.xlf'), 48 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCustomeraccountlinksAdmin.en-US.xlf'), 49 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesWirepaymentAdmin.en-US.xlf'), 50 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCheckpaymentAdmin.en-US.xlf'), 51 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesFacetedsearchAdmin.en-US.xlf'), 52 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminModulesFeature.en-US.xlf'), 53 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminOrderscustomersNotification.en-US.xlf'), 54 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminDesignNotification.en-US.xlf'), 55 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminNavigationFooter.en-US.xlf'), 56 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatssalesAdmin.en-US.xlf'), 57 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSearchbarAdmin.en-US.xlf'), 58 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopThemeCheckout.en-US.xlf'), 59 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminInternationalNotification.en-US.xlf'), 60 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesBestsellersShop.en-US.xlf'), 61 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCarriercomparisonAdmin.en-US.xlf'), 62 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsliveAdmin.en-US.xlf'), 63 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminModulesNotification.en-US.xlf'), 64 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesNewproductsAdmin.en-US.xlf'), 65 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCrosssellingShop.en-US.xlf'), 66 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSocialfollowAdmin.en-US.xlf'), 67 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsequipmentAdmin.en-US.xlf'), 68 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCustomtextAdmin.en-US.xlf'), 69 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminAdvparametersFeature.en-US.xlf'), 70 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSharebuttonsAdmin.en-US.xlf'), 71 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesDataprivacyAdmin.en-US.xlf'), 72 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminLoginNotification.en-US.xlf'), 73 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsstockAdmin.en-US.xlf'), 74 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopFormsHelp.en-US.xlf'), 75 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesPscleanerAdmin.en-US.xlf'), 76 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminOrderscustomersHelp.en-US.xlf'), 77 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopThemeGlobal.en-US.xlf'), 78 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopNotificationsInfo.en-US.xlf'), 79 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminLoginFeature.en-US.xlf'), 80 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminCatalogHelp.en-US.xlf'), 81 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminNotificationsWarning.en-US.xlf'), 82 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminNotificationsError.en-US.xlf'), 83 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopThemeActions.en-US.xlf'), 84 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatssearchAdmin.en-US.xlf'), 85 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesLegalcomplianceAdmin.en-US.xlf'), 86 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesLanguageselectorAdmin.en-US.xlf'), 87 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesImagesliderAdmin.en-US.xlf'), 88 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsforecastAdmin.en-US.xlf'), 89 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesDataprivacyShop.en-US.xlf'), 90 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesViewedproductShop.en-US.xlf'), 91 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsoriginAdmin.en-US.xlf'), 92 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesWelcomeAdmin.en-US.xlf'), 93 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopThemeCustomeraccount.en-US.xlf'), 94 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminCatalogFeature.en-US.xlf'), 95 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCashondeliveryShop.en-US.xlf'), 96 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesFeaturedproductsShop.en-US.xlf'), 97 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesContactformAdmin.en-US.xlf'), 98 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatscheckupAdmin.en-US.xlf'), 99 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminStatsHelp.en-US.xlf'), 100 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSearchbarShop.en-US.xlf'), 101 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopNotificationsSuccess.en-US.xlf'), 102 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminGlobal.en-US.xlf'), 103 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminNavigationMenu.en-US.xlf'), 104 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCheckpaymentShop.en-US.xlf'), 105 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesEmailsubscriptionAdmin.en-US.xlf'), 106 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesPagesnotfoundAdmin.en-US.xlf'), 107 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesTrackingfrontShop.en-US.xlf'), 108 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesWirepaymentShop.en-US.xlf'), 109 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminNotificationsInfo.en-US.xlf'), 110 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsbestvouchersAdmin.en-US.xlf'), 111 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminModulesHelp.en-US.xlf'), 112 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatspersonalinfosAdmin.en-US.xlf'), 113 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminPaymentHelp.en-US.xlf'), 114 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesLivetranslationAdmin.en-US.xlf'), 115 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesDashtrendsAdmin.en-US.xlf'), 116 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminAdvparametersNotification.en-US.xlf'), 117 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSharebuttonsShop.en-US.xlf'), 118 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesNewproductsShop.en-US.xlf'), 119 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesMailalertsAdmin.en-US.xlf'), 120 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesLinklistShop.en-US.xlf'), 121 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopThemeCatalog.en-US.xlf'), 122 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminInternationalFeature.en-US.xlf'), 123 => ($this->targetDirs[2].'/Resources/translations/en-US/messages.en-US.xlf'), 124 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesBrandlistShop.en-US.xlf'), 125 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesNewsletterAdmin.en-US.xlf'), 126 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesAutoupgradeAdmin.en-US.xlf'), 127 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesContactformShop.en-US.xlf'), 128 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopThemeCustomerAccount.en-US.xlf'), 129 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesBrandlistAdmin.en-US.xlf'), 130 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSocialfollowShop.en-US.xlf'), 131 => ($this->targetDirs[2].'/Resources/translations/en-US/Install.en-US.xlf'), 132 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatscatalogAdmin.en-US.xlf'), 133 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminAdvparametersHelp.en-US.xlf'), 134 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesGridhtmlAdmin.en-US.xlf'), 135 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopNavigation.en-US.xlf'), 136 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesSupplierlistAdmin.en-US.xlf'), 137 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopFormsErrors.en-US.xlf'), 138 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesFeederAdmin.en-US.xlf'), 139 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesMainmenuAdmin.en-US.xlf'), 140 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCurrencyselectorAdmin.en-US.xlf'), 141 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesMailalertsShop.en-US.xlf'), 142 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCategoryproductsShop.en-US.xlf'), 143 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesDashgoalsAdmin.en-US.xlf'), 144 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCarriercomparisonShop.en-US.xlf'), 145 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminShippingHelp.en-US.xlf'), 146 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesRssfeedShop.en-US.xlf'), 147 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminDesignFeature.en-US.xlf'), 148 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminDashboardFeature.en-US.xlf'), 149 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsbestcategoriesAdmin.en-US.xlf'), 150 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminShippingNotification.en-US.xlf'), 151 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminNavigationHeader.en-US.xlf'), 152 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesBannerShop.en-US.xlf'), 153 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminNavigationNotification.en-US.xlf'), 154 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesViewedproductAdmin.en-US.xlf'), 155 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCategoryproductsAdmin.en-US.xlf'), 156 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesDashactivityAdmin.en-US.xlf'), 157 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesContactinfoAdmin.en-US.xlf'), 158 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesAdvertisingAdmin.en-US.xlf'), 159 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopFormsLabels.en-US.xlf'), 160 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminShopparametersFeature.en-US.xlf'), 161 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsregistrationsAdmin.en-US.xlf'), 162 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesLivetranslationShop.en-US.xlf'), 163 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesRssfeedAdmin.en-US.xlf'), 164 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminPaymentNotification.en-US.xlf'), 165 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminShopparametersHelp.en-US.xlf'), 166 => ($this->targetDirs[2].'/Resources/translations/en-US/ShopNotificationsError.en-US.xlf'), 167 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesCashondeliveryAdmin.en-US.xlf'), 168 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesBlockreassuranceShop.en-US.xlf'), 169 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesStatsnewsletterAdmin.en-US.xlf'), 170 => ($this->targetDirs[2].'/Resources/translations/en-US/ModulesGraphnvd3Admin.en-US.xlf'), 171 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminCatalogNotification.en-US.xlf'), 172 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminNotificationsSuccess.en-US.xlf'), 173 => ($this->targetDirs[2].'/Resources/translations/en-US/AdminDashboardHelp.en-US.xlf')), 'es-ES' => array(0 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesRssfeedShop.es-ES.xlf'), 1 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesSpecialsShop.es-ES.xlf'), 2 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesSharebuttonsShop.es-ES.xlf'), 3 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatsstockAdmin.es-ES.xlf'), 4 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminStatsNotification.es-ES.xlf'), 5 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminDesignNotification.es-ES.xlf'), 6 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesSearchbarAdmin.es-ES.xlf'), 7 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesMailalertsAdmin.es-ES.xlf'), 8 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesWirepaymentAdmin.es-ES.xlf'), 9 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminShippingNotification.es-ES.xlf'), 10 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatscheckupAdmin.es-ES.xlf'), 11 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesSpecialsAdmin.es-ES.xlf'), 12 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminModulesNotification.es-ES.xlf'), 13 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatsregistrationsAdmin.es-ES.xlf'), 14 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesSekeywordsAdmin.es-ES.xlf'), 15 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminDashboardHelp.es-ES.xlf'), 16 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesWirepaymentShop.es-ES.xlf'), 17 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatscatalogAdmin.es-ES.xlf'), 18 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesDashtrendsAdmin.es-ES.xlf'), 19 => ($this->targetDirs[2].'/Resources/translations/es-ES/ShopThemeCustomeraccount.es-ES.xlf'), 20 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesLinklistAdmin.es-ES.xlf'), 21 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminOrderscustomersFeature.es-ES.xlf'), 22 => ($this->targetDirs[2].'/Resources/translations/es-ES/ShopFormsErrors.es-ES.xlf'), 23 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesBlockreassuranceShop.es-ES.xlf'), 24 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatsequipmentAdmin.es-ES.xlf'), 25 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatsbestvouchersAdmin.es-ES.xlf'), 26 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesWelcomeAdmin.es-ES.xlf'), 27 => ($this->targetDirs[2].'/Resources/translations/es-ES/ShopDemoCatalog.es-ES.xlf'), 28 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminNavigationSearch.es-ES.xlf'), 29 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesLegalcomplianceAdmin.es-ES.xlf'), 30 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminAdvparametersHelp.es-ES.xlf'), 31 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesAutoupgradeAdmin.es-ES.xlf'), 32 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesAdvertisingAdmin.es-ES.xlf'), 33 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesSupplierlistAdmin.es-ES.xlf'), 34 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesMailalertsShop.es-ES.xlf'), 35 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminInternationalNotification.es-ES.xlf'), 36 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesDateofdeliveryShop.es-ES.xlf'), 37 => ($this->targetDirs[2].'/Resources/translations/es-ES/ShopNotificationsInfo.es-ES.xlf'), 38 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesBannerShop.es-ES.xlf'), 39 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesGridhtmlAdmin.es-ES.xlf'), 40 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesContactformAdmin.es-ES.xlf'), 41 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesFeederAdmin.es-ES.xlf'), 42 => ($this->targetDirs[2].'/Resources/translations/es-ES/Install.es-ES.xlf'), 43 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatssearchAdmin.es-ES.xlf'), 44 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesDateofdeliveryAdmin.es-ES.xlf'), 45 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesProductinfoAdmin.es-ES.xlf'), 46 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesDashproductsAdmin.es-ES.xlf'), 47 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesLanguageselectorAdmin.es-ES.xlf'), 48 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminPaymentNotification.es-ES.xlf'), 49 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesTrackingfrontShop.es-ES.xlf'), 50 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminPaymentHelp.es-ES.xlf'), 51 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesDataprivacyShop.es-ES.xlf'), 52 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminPaymentFeature.es-ES.xlf'), 53 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatscarrierAdmin.es-ES.xlf'), 54 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminCatalogHelp.es-ES.xlf'), 55 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesCurrencyselectorAdmin.es-ES.xlf'), 56 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatsbestcategoriesAdmin.es-ES.xlf'), 57 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesEmailsubscriptionAdmin.es-ES.xlf'), 58 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesPagesnotfoundAdmin.es-ES.xlf'), 59 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatsforecastAdmin.es-ES.xlf'), 60 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesSearchbarShop.es-ES.xlf'), 61 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatspersonalinfosAdmin.es-ES.xlf'), 62 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesCustomeraccountlinksAdmin.es-ES.xlf'), 63 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminOrderscustomersNotification.es-ES.xlf'), 64 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesMainmenuAdmin.es-ES.xlf'), 65 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesLivetranslationShop.es-ES.xlf'), 66 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminInternationalHelp.es-ES.xlf'), 67 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesBlockreassuranceAdmin.es-ES.xlf'), 68 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminShippingHelp.es-ES.xlf'), 69 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesCarriercomparisonAdmin.es-ES.xlf'), 70 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesSocialfollowShop.es-ES.xlf'), 71 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesSharebuttonsAdmin.es-ES.xlf'), 72 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesLinklistShop.es-ES.xlf'), 73 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminDesignHelp.es-ES.xlf'), 74 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminStatsFeature.es-ES.xlf'), 75 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminDesignFeature.es-ES.xlf'), 76 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatsnewsletterAdmin.es-ES.xlf'), 77 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesPscleanerAdmin.es-ES.xlf'), 78 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminOrderscustomersHelp.es-ES.xlf'), 79 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesCategoryproductsAdmin.es-ES.xlf'), 80 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesFeaturedproductsAdmin.es-ES.xlf'), 81 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesLivetranslationAdmin.es-ES.xlf'), 82 => ($this->targetDirs[2].'/Resources/translations/es-ES/EmailsSubject.es-ES.xlf'), 83 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesDataprivacyAdmin.es-ES.xlf'), 84 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesRssfeedAdmin.es-ES.xlf'), 85 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminModulesFeature.es-ES.xlf'), 86 => ($this->targetDirs[2].'/Resources/translations/es-ES/messages.es-ES.xlf'), 87 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatsvisitsAdmin.es-ES.xlf'), 88 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesCheckpaymentShop.es-ES.xlf'), 89 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesCrosssellingAdmin.es-ES.xlf'), 90 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesContactinfoAdmin.es-ES.xlf'), 91 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminNotificationsSuccess.es-ES.xlf'), 92 => ($this->targetDirs[2].'/Resources/translations/es-ES/ShopThemeCustomerAccount.es-ES.xlf'), 93 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesSocialfollowAdmin.es-ES.xlf'), 94 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesCashondeliveryShop.es-ES.xlf'), 95 => ($this->targetDirs[2].'/Resources/translations/es-ES/ShopThemeCheckout.es-ES.xlf'), 96 => ($this->targetDirs[2].'/Resources/translations/es-ES/EmailsBody.es-ES.xlf'), 97 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesCheckpaymentAdmin.es-ES.xlf'), 98 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatsdataAdmin.es-ES.xlf'), 99 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesSupplierlistShop.es-ES.xlf'), 100 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesShoppingcartAdmin.es-ES.xlf'), 101 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminNotificationsWarning.es-ES.xlf'), 102 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatsbestproductsAdmin.es-ES.xlf'), 103 => ($this->targetDirs[2].'/Resources/translations/es-ES/ShopThemeCatalog.es-ES.xlf'), 104 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesReminderAdmin.es-ES.xlf'), 105 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesCustomersigninAdmin.es-ES.xlf'), 106 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesCategorytreeAdmin.es-ES.xlf'), 107 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminNavigationNotification.es-ES.xlf'), 108 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminShopparametersNotification.es-ES.xlf'), 109 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesBrandlistShop.es-ES.xlf'), 110 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminNavigationMenu.es-ES.xlf'), 111 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesNewsletterAdmin.es-ES.xlf'), 112 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatsbestmanufacturersAdmin.es-ES.xlf'), 113 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesNewproductsAdmin.es-ES.xlf'), 114 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminLoginNotification.es-ES.xlf'), 115 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminAdvparametersNotification.es-ES.xlf'), 116 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminCatalogNotification.es-ES.xlf'), 117 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminModulesHelp.es-ES.xlf'), 118 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesViewedproductAdmin.es-ES.xlf'), 119 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminActions.es-ES.xlf'), 120 => ($this->targetDirs[2].'/Resources/translations/es-ES/ShopThemeActions.es-ES.xlf'), 121 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesTrackingfrontAdmin.es-ES.xlf'), 122 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatsliveAdmin.es-ES.xlf'), 123 => ($this->targetDirs[2].'/Resources/translations/es-ES/ShopThemeGlobal.es-ES.xlf'), 124 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminDashboardNotification.es-ES.xlf'), 125 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminNotificationsInfo.es-ES.xlf'), 126 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatsoriginAdmin.es-ES.xlf'), 127 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesBannerAdmin.es-ES.xlf'), 128 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatsproductAdmin.es-ES.xlf'), 129 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminShopparametersHelp.es-ES.xlf'), 130 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesGraphnvd3Admin.es-ES.xlf'), 131 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminStatsHelp.es-ES.xlf'), 132 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesCrosssellingShop.es-ES.xlf'), 133 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminNotificationsError.es-ES.xlf'), 134 => ($this->targetDirs[2].'/Resources/translations/es-ES/ShopFormsHelp.es-ES.xlf'), 135 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesDashgoalsAdmin.es-ES.xlf'), 136 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminCatalogFeature.es-ES.xlf'), 137 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminNavigationFooter.es-ES.xlf'), 138 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesCashondeliveryAdmin.es-ES.xlf'), 139 => ($this->targetDirs[2].'/Resources/translations/es-ES/ShopFormsLabels.es-ES.xlf'), 140 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminShippingFeature.es-ES.xlf'), 141 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesDashactivityAdmin.es-ES.xlf'), 142 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesCustomtextAdmin.es-ES.xlf'), 143 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminDashboardFeature.es-ES.xlf'), 144 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesBestsellersShop.es-ES.xlf'), 145 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesViewedproductShop.es-ES.xlf'), 146 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesFacetedsearchAdmin.es-ES.xlf'), 147 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminAdvparametersFeature.es-ES.xlf'), 148 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminGlobal.es-ES.xlf'), 149 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesContactinfoShop.es-ES.xlf'), 150 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminInternationalFeature.es-ES.xlf'), 151 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesLegalcomplianceShop.es-ES.xlf'), 152 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminShopparametersFeature.es-ES.xlf'), 153 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesGAnalyticsAdmin.es-ES.xlf'), 154 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesFeaturedproductsShop.es-ES.xlf'), 155 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminLoginFeature.es-ES.xlf'), 156 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesFacetedsearchShop.es-ES.xlf'), 157 => ($this->targetDirs[2].'/Resources/translations/es-ES/ShopNotificationsSuccess.es-ES.xlf'), 158 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesCarriercomparisonShop.es-ES.xlf'), 159 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatsbestcustomersAdmin.es-ES.xlf'), 160 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesImagesliderAdmin.es-ES.xlf'), 161 => ($this->targetDirs[2].'/Resources/translations/es-ES/ShopNavigation.es-ES.xlf'), 162 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesCategoryproductsShop.es-ES.xlf'), 163 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesContactformShop.es-ES.xlf'), 164 => ($this->targetDirs[2].'/Resources/translations/es-ES/ShopNotificationsError.es-ES.xlf'), 165 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatssalesAdmin.es-ES.xlf'), 166 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesBestsellersAdmin.es-ES.xlf'), 167 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesStatsbestsuppliersAdmin.es-ES.xlf'), 168 => ($this->targetDirs[2].'/Resources/translations/es-ES/ShopNotificationsWarning.es-ES.xlf'), 169 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesBrandlistAdmin.es-ES.xlf'), 170 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesNewproductsShop.es-ES.xlf'), 171 => ($this->targetDirs[2].'/Resources/translations/es-ES/AdminNavigationHeader.es-ES.xlf'), 172 => ($this->targetDirs[2].'/Resources/translations/es-ES/ModulesEmailsubscriptionShop.es-ES.xlf'), 173 => ($this->targetDirs[2].'/Resources/translations/es-ES/ShopPdf.es-ES.xlf')), 'fr-CA' => array(0 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminCatalogFeature.fr-CA.xlf'), 1 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesBestsellersAdmin.fr-CA.xlf'), 2 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesBlockreassuranceShop.fr-CA.xlf'), 3 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminNotificationsWarning.fr-CA.xlf'), 4 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesCashondeliveryAdmin.fr-CA.xlf'), 5 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesWelcomeAdmin.fr-CA.xlf'), 6 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesSearchbarAdmin.fr-CA.xlf'), 7 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesAutoupgradeAdmin.fr-CA.xlf'), 8 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminNavigationFooter.fr-CA.xlf'), 9 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminActions.fr-CA.xlf'), 10 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminOrderscustomersHelp.fr-CA.xlf'), 11 => ($this->targetDirs[2].'/Resources/translations/fr-CA/Install.fr-CA.xlf'), 12 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminAdvparametersNotification.fr-CA.xlf'), 13 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ShopThemeCatalog.fr-CA.xlf'), 14 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminNavigationMenu.fr-CA.xlf'), 15 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminStatsHelp.fr-CA.xlf'), 16 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatsnewsletterAdmin.fr-CA.xlf'), 17 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminShopparametersNotification.fr-CA.xlf'), 18 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesProductinfoAdmin.fr-CA.xlf'), 19 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminDashboardFeature.fr-CA.xlf'), 20 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatsforecastAdmin.fr-CA.xlf'), 21 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesBannerShop.fr-CA.xlf'), 22 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminNotificationsSuccess.fr-CA.xlf'), 23 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminLoginFeature.fr-CA.xlf'), 24 => ($this->targetDirs[2].'/Resources/translations/fr-CA/EmailsBody.fr-CA.xlf'), 25 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesCrosssellingAdmin.fr-CA.xlf'), 26 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesReminderAdmin.fr-CA.xlf'), 27 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesRssfeedShop.fr-CA.xlf'), 28 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminCatalogHelp.fr-CA.xlf'), 29 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminDesignNotification.fr-CA.xlf'), 30 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatsregistrationsAdmin.fr-CA.xlf'), 31 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminDesignHelp.fr-CA.xlf'), 32 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesDataprivacyShop.fr-CA.xlf'), 33 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesSupplierlistAdmin.fr-CA.xlf'), 34 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesSupplierlistShop.fr-CA.xlf'), 35 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesBannerAdmin.fr-CA.xlf'), 36 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminAdvparametersFeature.fr-CA.xlf'), 37 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesBrandlistShop.fr-CA.xlf'), 38 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminModulesHelp.fr-CA.xlf'), 39 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminAdvparametersHelp.fr-CA.xlf'), 40 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminShippingHelp.fr-CA.xlf'), 41 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesCustomersigninAdmin.fr-CA.xlf'), 42 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminShopparametersHelp.fr-CA.xlf'), 43 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesLanguageselectorAdmin.fr-CA.xlf'), 44 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatsstockAdmin.fr-CA.xlf'), 45 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminModulesFeature.fr-CA.xlf'), 46 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatsproductAdmin.fr-CA.xlf'), 47 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesLinklistShop.fr-CA.xlf'), 48 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesCategoryproductsAdmin.fr-CA.xlf'), 49 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatsoriginAdmin.fr-CA.xlf'), 50 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesLivetranslationShop.fr-CA.xlf'), 51 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ShopFormsErrors.fr-CA.xlf'), 52 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminInternationalFeature.fr-CA.xlf'), 53 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminStatsNotification.fr-CA.xlf'), 54 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesDashtrendsAdmin.fr-CA.xlf'), 55 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesFacetedsearchAdmin.fr-CA.xlf'), 56 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesLegalcomplianceShop.fr-CA.xlf'), 57 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesNewproductsShop.fr-CA.xlf'), 58 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminInternationalNotification.fr-CA.xlf'), 59 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ShopDemoCatalog.fr-CA.xlf'), 60 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ShopNotificationsError.fr-CA.xlf'), 61 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesGridhtmlAdmin.fr-CA.xlf'), 62 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesMailalertsShop.fr-CA.xlf'), 63 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesCashondeliveryShop.fr-CA.xlf'), 64 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminNavigationHeader.fr-CA.xlf'), 65 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesCurrencyselectorAdmin.fr-CA.xlf'), 66 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesViewedproductAdmin.fr-CA.xlf'), 67 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesCategorytreeAdmin.fr-CA.xlf'), 68 => ($this->targetDirs[2].'/Resources/translations/fr-CA/EmailsSubject.fr-CA.xlf'), 69 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesWirepaymentAdmin.fr-CA.xlf'), 70 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatscatalogAdmin.fr-CA.xlf'), 71 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesTrackingfrontShop.fr-CA.xlf'), 72 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ShopFormsLabels.fr-CA.xlf'), 73 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesDashgoalsAdmin.fr-CA.xlf'), 74 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesCheckpaymentShop.fr-CA.xlf'), 75 => ($this->targetDirs[2].'/Resources/translations/fr-CA/messages.fr-CA.xlf'), 76 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ShopFormsHelp.fr-CA.xlf'), 77 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesSearchbarShop.fr-CA.xlf'), 78 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ShopThemeGlobal.fr-CA.xlf'), 79 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesLegalcomplianceAdmin.fr-CA.xlf'), 80 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesSharebuttonsAdmin.fr-CA.xlf'), 81 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesSpecialsAdmin.fr-CA.xlf'), 82 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesCarriercomparisonShop.fr-CA.xlf'), 83 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesPagesnotfoundAdmin.fr-CA.xlf'), 84 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesSocialfollowAdmin.fr-CA.xlf'), 85 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminStatsFeature.fr-CA.xlf'), 86 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminShippingNotification.fr-CA.xlf'), 87 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ShopPdf.fr-CA.xlf'), 88 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ShopNotificationsSuccess.fr-CA.xlf'), 89 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatsbestmanufacturersAdmin.fr-CA.xlf'), 90 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesBestsellersShop.fr-CA.xlf'), 91 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesPscleanerAdmin.fr-CA.xlf'), 92 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesGraphnvd3Admin.fr-CA.xlf'), 93 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminShopparametersFeature.fr-CA.xlf'), 94 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatsequipmentAdmin.fr-CA.xlf'), 95 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesDashproductsAdmin.fr-CA.xlf'), 96 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatspersonalinfosAdmin.fr-CA.xlf'), 97 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminNavigationSearch.fr-CA.xlf'), 98 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesFacetedsearchShop.fr-CA.xlf'), 99 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesLivetranslationAdmin.fr-CA.xlf'), 100 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesViewedproductShop.fr-CA.xlf'), 101 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesCrosssellingShop.fr-CA.xlf'), 102 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesMainmenuAdmin.fr-CA.xlf'), 103 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesMailalertsAdmin.fr-CA.xlf'), 104 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesImagesliderAdmin.fr-CA.xlf'), 105 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesShoppingcartAdmin.fr-CA.xlf'), 106 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminInternationalHelp.fr-CA.xlf'), 107 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesFeaturedproductsShop.fr-CA.xlf'), 108 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesContactinfoAdmin.fr-CA.xlf'), 109 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminCatalogNotification.fr-CA.xlf'), 110 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesTrackingfrontAdmin.fr-CA.xlf'), 111 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminNotificationsError.fr-CA.xlf'), 112 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminDashboardHelp.fr-CA.xlf'), 113 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesFeederAdmin.fr-CA.xlf'), 114 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesSharebuttonsShop.fr-CA.xlf'), 115 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatsdataAdmin.fr-CA.xlf'), 116 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesSpecialsShop.fr-CA.xlf'), 117 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ShopNotificationsWarning.fr-CA.xlf'), 118 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminNotificationsInfo.fr-CA.xlf'), 119 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesEmailsubscriptionShop.fr-CA.xlf'), 120 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesBrandlistAdmin.fr-CA.xlf'), 121 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatscarrierAdmin.fr-CA.xlf'), 122 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ShopThemeCheckout.fr-CA.xlf'), 123 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminDesignFeature.fr-CA.xlf'), 124 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminPaymentFeature.fr-CA.xlf'), 125 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminPaymentNotification.fr-CA.xlf'), 126 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesDashactivityAdmin.fr-CA.xlf'), 127 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminOrderscustomersNotification.fr-CA.xlf'), 128 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesCheckpaymentAdmin.fr-CA.xlf'), 129 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminGlobal.fr-CA.xlf'), 130 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatsbestcategoriesAdmin.fr-CA.xlf'), 131 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ShopThemeCustomeraccount.fr-CA.xlf'), 132 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesGAnalyticsAdmin.fr-CA.xlf'), 133 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesContactinfoShop.fr-CA.xlf'), 134 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatsbestvouchersAdmin.fr-CA.xlf'), 135 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatsliveAdmin.fr-CA.xlf'), 136 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatssearchAdmin.fr-CA.xlf'), 137 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesRssfeedAdmin.fr-CA.xlf'), 138 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatscheckupAdmin.fr-CA.xlf'), 139 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ShopThemeActions.fr-CA.xlf'), 140 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatsbestproductsAdmin.fr-CA.xlf'), 141 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesNewproductsAdmin.fr-CA.xlf'), 142 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesDateofdeliveryAdmin.fr-CA.xlf'), 143 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesBlockreassuranceAdmin.fr-CA.xlf'), 144 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminModulesNotification.fr-CA.xlf'), 145 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesFeaturedproductsAdmin.fr-CA.xlf'), 146 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesAdvertisingAdmin.fr-CA.xlf'), 147 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesSocialfollowShop.fr-CA.xlf'), 148 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesDataprivacyAdmin.fr-CA.xlf'), 149 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesEmailsubscriptionAdmin.fr-CA.xlf'), 150 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatssalesAdmin.fr-CA.xlf'), 151 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesLinklistAdmin.fr-CA.xlf'), 152 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ShopNotificationsInfo.fr-CA.xlf'), 153 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatsbestcustomersAdmin.fr-CA.xlf'), 154 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatsbestsuppliersAdmin.fr-CA.xlf'), 155 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminOrderscustomersFeature.fr-CA.xlf'), 156 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesDateofdeliveryShop.fr-CA.xlf'), 157 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesCarriercomparisonAdmin.fr-CA.xlf'), 158 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminShippingFeature.fr-CA.xlf'), 159 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesCustomtextAdmin.fr-CA.xlf'), 160 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminPaymentHelp.fr-CA.xlf'), 161 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesContactformShop.fr-CA.xlf'), 162 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesCategoryproductsShop.fr-CA.xlf'), 163 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesCustomeraccountlinksAdmin.fr-CA.xlf'), 164 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesContactformAdmin.fr-CA.xlf'), 165 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesStatsvisitsAdmin.fr-CA.xlf'), 166 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminLoginNotification.fr-CA.xlf'), 167 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminDashboardNotification.fr-CA.xlf'), 168 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesSekeywordsAdmin.fr-CA.xlf'), 169 => ($this->targetDirs[2].'/Resources/translations/fr-CA/AdminNavigationNotification.fr-CA.xlf'), 170 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ShopThemeCustomerAccount.fr-CA.xlf'), 171 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesWirepaymentShop.fr-CA.xlf'), 172 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ShopNavigation.fr-CA.xlf'), 173 => ($this->targetDirs[2].'/Resources/translations/fr-CA/ModulesNewsletterAdmin.fr-CA.xlf')))), array());
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('AEH8HGGUXMgrUZfoPgwDizFDPzxx3V3RdeMgLIVQa7ctiMHmotvy1GRU');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5b41736dad38c5.51809847')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => 'lyricsshop.meeta.online',
            'database_port' => '',
            'database_name' => 'lyricsshop',
            'database_user' => 'lyricsshop',
            'database_password' => 'Ponycorn_90',
            'database_prefix' => 'lys',
            ...
            'secret' => 'AEH8HGGUXMgrUZfoPgwDizFDPzxx3V3RdeMgLIVQa7ctiMHmotvy1GRU',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-07-07',
            'locale' => 'en-US',
            'cookie_key' => 'S10GOtBK2J2FaYHOgLBf9ytbc0974q0LxNxx8wchnnQHCTg0w9q72Dw8',
            'cookie_iv' => 'fbVGKI9C',
            'new_cookie_key' => 'def000001bb6a87c9da43428c04b38192ab5f46883fa288b2b92e5e20e12577b128b0f141a2cc3b024afaa49daddb9b3bdb85b291f4319062bcf3bb7ef42fd2f3284fd02',
            ...
            'kernel.secret' => 'AEH8HGGUXMgrUZfoPgwDizFDPzxx3V3RdeMgLIVQa7ctiMHmotvy1GRU',

...
$(document).ready(function(){
	...
	//scroll menu
	if($('.menu-cart-search').length > 0){
		var headerSpaceH = $('.menu-cart-search').outerHeight(true);
		$('.menu-cart-search').after('<div class="headerSpace unvisible" style="height: '+headerSpaceH+'px;" ></div>');
	}
	...
	{	
		...
		$(window).scroll(function() {    
			...
			if (scroll >= headerSpaceH) {
				$(".menu-cart-search").addClass("scroll-menu");
			  $('.headerSpace').removeClass('unvisible');
			}else{
			  $(".menu-cart-search").removeClass("scroll-menu");
